...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='location',
            name='address',
            field=models.CharField(default='Iran-Tehran', help_text='آدرس کامل محل را وارد کنید', max_length=500, verbose_name='آدرس'),
        ),
        migrations.AlterField(
            model_name='location',
            name='capacity',
            field=models.IntegerField(help_text='حداکثر ظرفیت محل', validators=[django.core.validators.MinValueValidator(1)], verbose_name='ظرفیت'),
        ),
        migrations.AlterField(
            model_name='location',
            name='closing_time',
        ...
        migrations.AlterField(
            model_name='location',
            name='id_number',
            field=models.IntegerField(primary_key=True, serialize=False, verbose_name='شماره شناسه'),
        ),
        migrations.AlterField(
            model_name='location',
            name='is_active',
        ...
        migrations.AlterField(
            model_name='location',
            name='location_type',
            field=models.CharField(choices=[('restaurant', 'رستوران'), ('shop', 'خرید کنید'), ('service_center', 'مرکز خدمات'), ('concert', 'کنسرت')], max_length=50, verbose_name='نوع مکان'),
        ),
        migrations.AlterField(
            model_name='location',
            name='longitude',
        ...
        migrations.AlterField(
            model_name='location',
            name='name',
            field=models.CharField(help_text='نام مکان را وارد کنید', max_length=100, verbose_name='نام مکان'),
        ),
        migrations.AlterField(
            model_name='location',
            name='opening_time',
        ...
        migrations.AlterField(
            model_name='location',
            name='phone',
            field=models.CharField(help_text='یک شماره تلفن معتبر وارد کنید', max_length=11, null=True, verbose_name='شماره تلفن'),
        ),
        migrations.AlterField(
            model_name='location',
            name='updated_at',
